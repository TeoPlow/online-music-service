...
import (
	...
	grpcapp "github.com/TeoPlow/online-music-service/src/auth/internal/app/grpc"
	"github.com/TeoPlow/online-music-service/src/auth/internal/config"
	"github.com/TeoPlow/online-music-service/src/auth/internal/grpc/auth"
	"github.com/TeoPlow/online-music-service/src/auth/internal/kafka/producer"
	"github.com/TeoPlow/online-music-service/src/auth/internal/logger"
	"github.com/TeoPlow/online-music-service/src/auth/internal/outbox"
	"github.com/TeoPlow/online-music-service/src/auth/internal/pkg/jwt"
	"github.com/TeoPlow/online-music-service/src/auth/internal/repository/postgres"
	redisRepo "github.com/TeoPlow/online-music-service/src/auth/internal/repository/redis"
	"github.com/TeoPlow/online-music-service/src/auth/internal/service"
	"github.com/TeoPlow/online-music-service/src/auth/internal/storage"
)
...
func SetupApplication() (*config.Config, error) {
	filepath := flag.String("path", "config/config.yaml", "путь к конфигурационному файлу")
	flag.Parse()
