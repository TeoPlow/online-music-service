...
// Source: src/auth_service/internal/storage/tx_manager.go
//
// Generated by this command:
//
//	mockgen -source=src/auth_service/internal/storage/tx_manager.go -destination=src/auth_service/internal/repository/mocks/tx_manager_mock.go -package=mocks
//
...
func (mr *MockTxManagerInterfaceMockRecorder) RunReadUncommited(ctx, f any) *gomock.Call {
...
func (mr *MockTxManagerInterfaceMockRecorder) RunSerializable(ctx, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
