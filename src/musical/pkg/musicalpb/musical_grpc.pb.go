...
const (
	...
	MusicalService_DownloadTrack_FullMethodName   = "/musical.MusicalService/DownloadTrack"
...
type MusicalServiceClient interface {
	...
	CreateTrack(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateTrackRequest, Track], error)
	...
	DownloadTrack(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadResponse], error)
...
func (c *musicalServiceClient) CreateTrack(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateTrackRequest, Track], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MusicalService_ServiceDesc.Streams[0], MusicalService_CreateTrack_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[CreateTrackRequest, Track]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MusicalService_CreateTrackClient = grpc.ClientStreamingClient[CreateTrackRequest, Track]
...
func (c *musicalServiceClient) DownloadTrack(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MusicalService_ServiceDesc.Streams[1], MusicalService_DownloadTrack_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[IDRequest, DownloadResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MusicalService_DownloadTrackClient = grpc.ServerStreamingClient[DownloadResponse]
...
type MusicalServiceServer interface {
	...
	CreateTrack(grpc.ClientStreamingServer[CreateTrackRequest, Track]) error
	...
	DownloadTrack(*IDRequest, grpc.ServerStreamingServer[DownloadResponse]) error
...
func (UnimplementedMusicalServiceServer) CreateTrack(grpc.ClientStreamingServer[CreateTrackRequest, Track]) error {
...
func (UnimplementedMusicalServiceServer) DownloadTrack(*IDRequest, grpc.ServerStreamingServer[DownloadResponse]) error {
...
func _MusicalService_CreateTrack_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MusicalServiceServer).CreateTrack(&grpc.GenericServerStream[CreateTrackRequest, Track]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MusicalService_CreateTrackServer = grpc.ClientStreamingServer[CreateTrackRequest, Track]
...
func _MusicalService_DownloadTrack_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MusicalServiceServer).DownloadTrack(m, &grpc.GenericServerStream[IDRequest, DownloadResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MusicalService_DownloadTrackServer = grpc.ServerStreamingServer[DownloadResponse]
